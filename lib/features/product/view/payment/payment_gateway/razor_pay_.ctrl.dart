...
import 'package:seller_management/features/product/view/payment_credentials/razorpay_credentials.dart';
...
class RazorPayPaymentCtrl {
  ...
  Future<void> initializePayment(BuildContext context) async {
    ...
    final options = {
      ...
      'prefill': {
        'name': details.billingAddress!.fullName,
        'contact': details.billingAddress!.phone,
