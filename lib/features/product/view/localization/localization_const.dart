...
class TR {
  ...
  static String paymentWait(BuildContext context) =>
      const LocaleKey('payment_wait').translate(context);
  ...
  static String paymentWaitMassage(BuildContext context) =>
      const LocaleKey('payment_wait_massage').translate(context);
  ...
  static String street(BuildContext context) =>
...
//
  ...
  static String receiver(BuildContext context) =>
      const LocaleKey('receiver').translate(context);

  static String offlinePayment(BuildContext context) =>
      const LocaleKey('offlinePayment').translate(context);
  static String waOrder(BuildContext context) =>
      const LocaleKey('waOrder').translate(context);
}
