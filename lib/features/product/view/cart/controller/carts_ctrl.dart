...
import 'package:seller_management/features/product/view/cart/repository/carts_repo.dart';
import 'package:seller_management/features/product/view/cart/repository/guest_carts.repo.dart';
...
import '../../user_content/carts_model.dart';
import '../../user_dash/controller/dash_ctrl.dart';
import '../../user_dash/provider/user_dash_provider.dart';
import '../../user_dash/repository/dash_repo.dart';
...
class CartCtrl extends AsyncNotifier<ItemListWithPageData<CartData>> {
  ...
  Future<void> addToCart({
    ...
    talk.debug("Adding to cart: Product UID: ${product.uid}, Attribute: $attribute, Campaign ID: $cUid");

    final loggedIn = ref.read(authCtrlProvider);
    if (loggedIn) {
      print("Button clicked! Product ID cart control");
  ...
  Future<void> _userAddToCart(
    ...
    print("Button clicked! Product ID: user add to cart method");
    talk.debug("compaignid $cUid");
  ...
  Future<void> _guestAddToCart(ProductsData product, String? attribute) async {
    print("Button clicked! Product ID: guestaddtocart");
